...
const Hero: React.FC = () => {
  return (
    <section className="hero-gradient min-h-[90vh] pt-32 pb-16 flex items-center relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <FadeIn direction="up" delay={0.3} className="flex flex-col sm:flex-row gap-4">
              <Button asChild className="bg-imperial-600 hover:bg-imperial-700 text-white rounded-lg py-6 px-8 text-base">
            ...
            <FadeIn direction="up" delay={0.4}>
              <div className="pt-8 flex items-center space-x-6">
                <p className="text-sm text-gray-600">Trusted by innovative companies:</p>
                <div className="flex space-x-6">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="h-8 w-16 bg-gray-200 rounded-md opacity-70" />
                  ))}
                </div>
              </div>
            </FadeIn>
